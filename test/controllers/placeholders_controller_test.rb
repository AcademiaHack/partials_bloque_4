...
class PlaceholdersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create placeholder" do
    assert_difference('Placeholder.count') do
      post placeholders_url, params: { placeholder: { location: @placeholder.location, total_floors: @placeholder.total_floors } }
    end
  ...
  test "should update placeholder" do
    patch placeholder_url(@placeholder), params: { placeholder: { location: @placeholder.location, total_floors: @placeholder.total_floors } }
